  ...
  Future<void> _onGetMatchsOfTeam(
    ...
    try {
      ...
      List<MatchGame> listMatchGame =
          await TeamMatchNetwork.instance.getAllMatchsByTeam(event.team.idTeam);
  ...
  Future<void> _onGetTeamsOfMatch(
    ...
    try {
      ListTeamMatchs listTeamMatchs =
          await TeamMatchNetwork.instance.getTeamsByMatch(event.match.idMatch);
